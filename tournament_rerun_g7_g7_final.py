...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------------
    # "g1_maps_rerun_g7_g7_final.json" will be replaced with a json file containing a specific map by a
    # shell script to duplicate this file for each tournament map
    parser.add_argument("--maps", "-m", default="g1_maps_rerun_g7_g7_final.json", help="Json for tournament maps")
    # ---------------------------------------------------------------------------
